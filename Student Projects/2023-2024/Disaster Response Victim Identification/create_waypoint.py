...
46px = 30cm --> 30/46 = MAP_SIZE_COEFF
"""
MAP_SIZE_COEFF = 1
Y_OFFSET = 284
X_OFFSET = 494
...
while running:
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            path_wp.append(toAppend)
            if index > 0:
                pygame.draw.line(screen, (255, 0, 0), (path_wp[index-1][1]/X_COF + X_OFFSET, path_wp[index-1][0]/Y_COF + Y_OFFSET), pos, 2)
            index += 1
